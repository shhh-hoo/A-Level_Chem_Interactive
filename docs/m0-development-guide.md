...
- [`supabase/functions/tests/integration/access-control.test.ts`](../supabase/functions/tests/integration/access-control.test.ts) — RLS/role-gating coverage for student/teacher isolation.
